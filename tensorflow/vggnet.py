...
#kernel_height, kernel_wedth, stride_height, stride_wedth, parameters
...
def fc_op(input_op, name, n_out, p):
    ...
    with tf.name_scope(name) as scope:
        ...
        biases = tf.Variable(tf.constant(0., shape= [n_out], dtype = tf.float32), name = 'b')
...
def inference_op(input_op, keep_prob):
    ...
    fc6_drop = tf.nn.dropout(fc6, keep_prob, name = 'fc6-drop')

    fc7 = fc_op(fc6_drop, name = 'fc7', n_out = 4096, p = p)
    fc7_drop = tf.nn.dropout(fc7, keep_prob, name = 'fc7-drop')
